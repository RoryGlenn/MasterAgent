...
def _validate_capabilities(
    ...
    if len(capabilities) != 97:
        errors.append(f"expected 97 v1 capabilities, found {len(capabilities)}")
    else:
        checks.append("capability catalog contains 97 typed capabilities")
