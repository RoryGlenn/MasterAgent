"""Restricted Windows child process for pure capability-capsule execution.
...
def _apply_limits(limits: dict[str, Any]) -> None:
    ...
    for name in required:
        ...
        parsed[name] = value
    # Native Windows applies these exact values to the suspended worker's Job
    # Object before resume. The child validates the protocol copy so host and
    # worker cannot silently disagree about the requested limits.
