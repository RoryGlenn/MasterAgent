...
| Change the GitHub Copilot custom-agent entry point, first-run setup, response contract, or tool boundary | [`MasterAgent.agent.md`](../.github/agents/MasterAgent.agent.md), [`AGENTS.md`](../AGENTS.md), [`.ai/MASTER_AGENT.md`](../.ai/MASTER_AGENT.md), [`.ai/FIRST_RUN.md`](../.ai/FIRST_RUN.md), [`bootstrap_agent.py`](../scripts/bootstrap_agent.py) | [`test_agent_bootstrap.py`](../tests/test_agent_bootstrap.py), [`test_release_metadata.py`](../tests/test_release_metadata.py), [`copilot-custom-agent.md`](copilot-custom-agent.md), [`release-validation.md`](release-validation.md) |
