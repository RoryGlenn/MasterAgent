...
| Add or change a CLI command | [`cli.py`](../src/master_agent/cli.py), [`__main__.py`](../src/master_agent/__main__.py) | [`test_cli.py`](../tests/test_cli.py), [`test_cli_v1.py`](../tests/test_cli_v1.py), [`test_cli_phase_completion.py`](../tests/test_cli_phase_completion.py) |
...
| GitHub | [`connectors/github.py`](../src/master_agent/connectors/github.py) | No write connector | [`test_github_connector.py`](../tests/test_github_connector.py) |
