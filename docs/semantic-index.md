...
| Normalize a read response, scan or terminal-render untrusted content, or verify a read independently | [`connectors/read_only.py`](../src/master_agent/connectors/read_only.py), [`security.py`](../src/master_agent/security.py), [`terminal.py`](../src/master_agent/terminal.py) | [`test_security.py`](../tests/test_security.py), [`test_terminal.py`](../tests/test_terminal.py), plus the provider-specific connector tests; [`phase-2-read-only.md`](phase-2-read-only.md) |
...
| Bound plan ingestion, model construction, or generated-artifact resources | [`resource_limits.py`](../src/master_agent/resource_limits.py), [`models.py`](../src/master_agent/models.py), [`capabilities.py`](../src/master_agent/capabilities.py) | [`test_resource_limits.py`](../tests/test_resource_limits.py), [`configuration.md`](configuration.md), [`threat-model.md`](threat-model.md) |
| Create local draft artifacts or manifests | [`connectors/drafts.py`](../src/master_agent/connectors/drafts.py), [`workflows/draft_package.py`](../src/master_agent/workflows/draft_package.py) | [`test_draft_package.py`](../tests/test_draft_package.py), [`test_draft_runtime_safety.py`](../tests/test_draft_runtime_safety.py), [`test_resource_limits.py`](../tests/test_resource_limits.py), [`phase-3-drafts.md`](phase-3-drafts.md) |
...
| Change the GitHub Copilot parent or advisory profiles, first-run setup, force-multiplier autonomy/stop conditions, persistent goal budgets, repository-state binding, route scope, response contract, or tool boundary | [`MasterAgent.agent.md`](../.github/agents/MasterAgent.agent.md), [`MasterAgent-Read-Researcher.agent.md`](../.github/agents/MasterAgent-Read-Researcher.agent.md), [`MasterAgent-Plan-Reviewer.agent.md`](../.github/agents/MasterAgent-Plan-Reviewer.agent.md), [`advisory.py`](../src/master_agent/advisory.py), [`advisory_budget.py`](../src/master_agent/advisory_budget.py), [`copilot_advisory.py`](../src/master_agent/copilot_advisory.py), [`advisory_subagent.py`](../scripts/advisory_subagent.py), [`AGENTS.md`](../AGENTS.md), [`.ai/MASTER_AGENT.md`](../.ai/MASTER_AGENT.md), [`.ai/FIRST_RUN.md`](../.ai/FIRST_RUN.md), [`.ai/AUTONOMY.md`](../.ai/AUTONOMY.md), [`bootstrap_agent.py`](../scripts/bootstrap_agent.py) | [`test_agent_bootstrap.py`](../tests/test_agent_bootstrap.py), [`test_agent_profiles.py`](../tests/test_agent_profiles.py), [`test_advisory_integration.py`](../tests/test_advisory_integration.py), [`test_advisory_budget.py`](../tests/test_advisory_budget.py), [`test_copilot_advisory.py`](../tests/test_copilot_advisory.py), [`test_advisory_runner.py`](../tests/test_advisory_runner.py), [`test_release_metadata.py`](../tests/test_release_metadata.py), [`copilot-custom-agent.md`](copilot-custom-agent.md), [`advisory-subagents.md`](advisory-subagents.md), [`release-validation.md`](release-validation.md) |
...
| Confluence | [`connectors/confluence.py`](../src/master_agent/connectors/confluence.py) | [`connectors/confluence_write.py`](../src/master_agent/connectors/confluence_write.py), Confluence draft in [`connectors/drafts.py`](../src/master_agent/connectors/drafts.py), bounded live sandbox harness in [`confluence_sandbox.py`](../scripts/confluence_sandbox.py) | [`test_atlassian_connectors.py`](../tests/test_atlassian_connectors.py), [`test_write_connectors.py`](../tests/test_write_connectors.py), [`test_confluence_sandbox.py`](../tests/test_confluence_sandbox.py), [live sandbox operations](confluence-sandbox-tests.md) |
...
| GitHub | [`connectors/github.py`](../src/master_agent/connectors/github.py) | Provider-verified reads plus bounded writes/admin in [`connectors/github_write.py`](../src/master_agent/connectors/github_write.py) | [`test_github_connector.py`](../tests/test_github_connector.py), [`test_github_write_connector.py`](../tests/test_github_write_connector.py) |
...
| Evidence bodies are persisted only under an explicit retention rule; expiration deletes only descriptor-validated, locked, complete pairs through bounded recoverable staging | [`retention.py`](../src/master_agent/retention.py), [`audit.py`](../src/master_agent/audit.py), [`cli.py`](../src/master_agent/cli.py) | [`test_retention.py`](../tests/test_retention.py), [`test_cli_phase_completion.py`](../tests/test_cli_phase_completion.py), [`test_audit_safety.py`](../tests/test_audit_safety.py) |
