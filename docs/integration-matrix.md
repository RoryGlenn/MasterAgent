...
| Confluence | Cloud basic/API token; Data Center bearer/basic | page search/read | create/update proposal | create Cloud space; create/update page | exact read; manual created-resource deletion; atomic versioned page restore | disabled |
