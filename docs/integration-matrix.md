...
| GitHub | Cloud bearer token with provider-verified numeric-user attestation | repository, PR search/read, commit check runs | — | unavailable | principal check before apply; independent normalized re-read | disabled |
