...
- [x] Define the shipped operator lifecycle and update requirement snapshot.
- [x] Implement environment-backed distinct capsule authority loading.
- [x] Implement CLI selection, promotion, status, routing, execution, disable, and revoke.
