...
- [x] Define the authoritative contract in `.ai/DOCS_AGENT.md`.
- [x] Add audience, plain-language, analogy, evidence-conflict, lifecycle,
...
- [x] Preserve the exact reviewed GitHub Copilot profile inventory and existing
  direct-host delegation boundary.
- [x] Run focused tests, `python scripts/specs.py validate`, and
  `python scripts/validate_release.py` through the pull-request validation gate.
