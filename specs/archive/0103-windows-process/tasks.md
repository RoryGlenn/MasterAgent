...
- [x] Add platform-neutral supervised execution result and fixed-command method.
- [x] Implement suspended Win32 launch with an exact inherited-handle list.
- [x] Configure and assign Job Object CPU, memory, process-count, and kill limits.
- [x] Build a bounded minimal environment and shared stdout/stderr budget.
- [x] Return secret-free typed exit, timeout, and native-control reasons.
